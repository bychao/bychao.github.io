...
## 刷盘策略
我们知道linux写文件并不是直接写到硬盘上的，而是定期刷，这样如果机器down了，有可能尚未刷盘的消息会丢失，metaQ提供了同步/异步两种刷盘方式，按需选择吧
![3fcfd146c73eb54e.png](https://private-alipayobjects.alipay.com/alipay-rmsdeploy-image/skylark/png/12981/3fcfd146c73eb54e.png) 
![b2e24185237cf61d.png](https://private-alipayobjects.alipay.com/alipay-rmsdeploy-image/skylark/png/12981/b2e24185237cf61d.png) 


## 顺序消息
metaQ支持顺序消息，担要求producer保证消息按顺序发送到同一个queue，比如msg1、msg2、msg3三个消息，如果要顺序到达consumer，则需要在producer发送时，按照特定规则，将消息发送到同一个queue。  
